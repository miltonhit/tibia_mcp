...
TEMPLATE = "Infobox_Achievement"
TABLE = "achievements"

COLUMNS = [
    "page_id", "name", "identifier", "status", "grade", "points",
    "obtainable", "secret", "premium", "implemented", "description", "notes",
]
...
BOOL_FIELDS = {"obtainable", "secret", "premium"}
INT_FIELDS = {"identifier", "grade", "points"}
CLEAN_FIELDS = {"description", "notes"}
