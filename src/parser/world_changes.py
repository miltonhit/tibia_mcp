...
TEMPLATE = "Infobox_World_Change"
TABLE = "world_changes"

COLUMNS = [
    "page_id", "name", "change_type", "frequency", "reward", "location",
    "level", "premium", "dangers", "bosses", "legend", "implemented", "notes",
]
...
BOOL_FIELDS = {"premium"}
INT_FIELDS = {"level"}
CLEAN_FIELDS = {"reward", "location", "dangers", "bosses", "legend", "notes"}
